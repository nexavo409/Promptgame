...
事実重視の文章や、特定の読者向けに調整したい時に必須の技法。`,
  ...
  },
  {
    id: 'lesson-06',
    number: 6,
    title: 'Chain of Thought（順を追って考えさせる）',
    technique: '"順を追って考えて" / "ステップ・バイ・ステップで"',
    summary: 'AIに「考える過程」を出力させると、論理的飛躍が減って正確性が上がります。',
    explainer: `Chain of Thought（CoT）は、複雑な推論や計算問題でAIの精度を大きく上げる技法。
「答えだけ出して」ではなく「考える過程を順を追って書いて、最後に結論を述べて」と指示します。
AIは思考過程を言語化することで、自分の論理を検証しながら進むため、誤った飛躍が減ります。`,
    hint: 'プロンプトに「順を追って考えてから結論を述べてください」を追加してみよう。',
    examplePrompt: '次の問題を解いてください。順を追って考えてから、最後に結論を述べてください。\n\n問題: 12人のチームで、ペアプロを毎日2時間ずつ行う。各メンバーは週に2回は別のメンバーとペアを組む必要がある。週5日として、何通りのペア組み合わせを計画する必要があるか。',
    topic: {
      category: 'tech',
      difficulty: 'high',
      title: 'ペアプロ組み合わせの計画',
...
ステップ3: 弱点を解消した改善版を出す`,
  ...
  },
  {
    ...
    summary: '役割・構造・制約・例示・CoT・自己批評を組み合わせて、実用的なプロンプトを書きましょう。',
